# coursera_reproducible_research-week4
...
Across the United States, which types of events (as indicated in the [Math Processing Error] variable) are most harmful with respect to population health?
